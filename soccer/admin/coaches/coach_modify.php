...
$path = array(
    ...
    array("name" => 'Modify Coach', "link" => '/' . $app_url_path . '/')
);
...
?>
    ...
    <form action="." method="post">
        ...
        <div id="box" class="container">
            <div class="row">
                <div class="header col s12"><h1 class="title">Modify Coach</h1></div>
            </div>

            <div class="row">
                <div class="coach_input project_name col s5">
                    <label class="spacing" for="coach_first_name">First Name</label>
                    <input type="text" name="coach_first_name" value="<?php echo htmlspecialchars($coach_first_name);?>" autofocus required>
                </div>
                <div class="coach_input project_name col s7">
                    <label class="spacing" for="coach_last_name">Last Name</label>
                    <input type="text" name="coach_last_name" value="<?php echo htmlspecialchars($coach_last_name);?>" required>
                </div>
            </div>
